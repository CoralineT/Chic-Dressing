		...
		<footer id="page-footer" class="<?php echo esc_attr(ashe_options( 'general_footer_width' )) === 'boxed' ? 'boxed-wrapper ': ''; ?>clear-fix">
			...
			<div class="footer-copyright">
				...
				<div class="credit">
					...
					printf( __( '%1$s Theme by <a aria-label="%4$s" href="%2$s">%3$s.</a>', 'ashe' ), esc_html( $theme_data->Name ), esc_url( 'http://wp-royal.com/' ), $theme_data->Author, "lien vers le créateur du thème WordPress");
					?>
				</div>
